...
try {
    ...
    WebUI.waitForElementClickable(findTestObject('04_Create Opportunity Test Cases Repo/Page_Create New Lead/EmailAddress_TextField'), GlobalVariable.MAX_Delay)

    WebUI.verifyElementPresent(findTestObject('04_Create Opportunity Test Cases Repo/Page_Create New Lead/label_First Name'), GlobalVariable.MAX_Delay)

    WebUI.verifyElementPresent(findTestObject('04_Create Opportunity Test Cases Repo/Page_Create New Lead/label_Last Name'), GlobalVariable.MAX_Delay)

    WebUI.verifyElementPresent(findTestObject('04_Create Opportunity Test Cases Repo/Page_Create New Lead/EmailAddress_TextField'), GlobalVariable.MAX_Delay)

    WebUI.verifyElementPresent(findTestObject('04_Create Opportunity Test Cases Repo/Page_Create New Lead/label_Mobile Phone'), GlobalVariable.MAX_Delay)

    WebUI.verifyElementPresent(findTestObject('04_Create Opportunity Test Cases Repo/Page_Create New Lead/label_State'), GlobalVariable.MAX_Delay)

    WebUI.verifyElementPresent(findTestObject('04_Create Opportunity Test Cases Repo/Page_Create New Lead/label_Zip Code'), GlobalVariable.MAX_Delay)
    ...
    int RN = ThreadLocalRandom.current().nextInt(100, 5000 + 1)

    WebUI.delay(GlobalVariable.MIN_Delay, FailureHandling.STOP_ON_FAILURE)

    WebUI.setText(findTestObject('04_Create Opportunity Test Cases Repo/Page_Create New Lead/EmailAddress_TextField'), ('AutomationTesting' + RN) + '@gmail.com')

    WebUI.delay(GlobalVariable.MIN_Delay, FailureHandling.STOP_ON_FAILURE)

    WebUI.setText(findTestObject('04_Create Opportunity Test Cases Repo/Page_Create New Lead/MobilePhone_TextField'), '8934657839')
