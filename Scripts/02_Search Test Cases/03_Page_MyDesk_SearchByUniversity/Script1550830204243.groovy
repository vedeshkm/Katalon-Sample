...
try {
    ...
    WebUI.clearText(findTestObject('Page_My Desk/Search_TextField'), FailureHandling.STOP_ON_FAILURE)

    WebUI.setText(findTestObject('Page_My Desk/Search_TextField'), 'Baylor')
