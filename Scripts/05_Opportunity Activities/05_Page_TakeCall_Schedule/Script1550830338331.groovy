...
try {
    ...
    WebUI.click(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Schedule_button'))

    WebUI.delay(2)

    WebUI.verifyElementPresent(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Page_Call_Schedule/Scheduling Activity_Label'), 2)

    WebUI.click(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Page_Call_Schedule/Page_Opportunity Details  Unified A/div_Agent Name'))

    WebUI.setText(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Page_Call_Schedule/Agent Name_TextField'), 'shivananda.ms')

    WebUI.click(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Page_Call_Schedule/Calender_Field'))

    WebUI.clearText(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Page_Call_Schedule/Calender_Field'))

    WebUI.delay(10)

    WebUI.setText(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Page_Call_Schedule/Calender_Field'), '28/12/2019 5:01 AM')

    WebUI.delay(1)

    WebUI.click(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Page_Call_Schedule/Schedule_Button'))
