...
try {
    ...
    WebUI.click(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Transfer_Button'))

    WebUI.delay(2)

    WebUI.verifyElementPresent(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Page_Transfer Activity/Transfer Activity_Label'), 2)

    WebUI.verifyElementPresent(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Page_Transfer Activity/Agent Name_Label'), 0)

    WebUI.setText(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Page_Transfer Activity/TransferAgent_TextField'), 'shivananda.ms')

    WebUI.delay(1)

    WebUI.click(findTestObject('05_Opportunity Activities Repo/Page_TakeCall_/Page_Transfer Activity/Transfer_Button'))
